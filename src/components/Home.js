            ...
            <div className={`p-3 mt-3 body-tertiary rounded-3 border ${props.bg_dark}`}>
                <div className="container-fluid py-5 ">
                    ...
                    <div className="col-md-12 mt-3 pt-2">
                        <span className="">
                            <a href={urls.github} style={{color:"inherit"}} target="_blank" className="shadow p-3  bg-body rounded"  rel="noopener noreferrer">
                        ...
                        <span className="m-3 ">
                            <a href={urls.linkedin} style={{color:"inherit"}}  className="shadow p-3  bg-body rounded" target="_blank"  rel="noopener noreferrer">
                        ...
                        <span className="m-3">
                            <a href={urls.twitter} style={{color:"inherit"}}  className="shadow p-3  bg-body rounded" target="_blank"  rel="noopener noreferrer">
                        ...
                        <span className="m-3">
                            <a href={urls.medium} style={{color:"inherit"}} className="shadow p-3  bg-body rounded"  target="_blank"  rel="noopener noreferrer">
                        ...
                        <span>
                            <a href={urls.youtube} style={{color:"inherit"}} className="shadow p-3  bg-body rounded"  target="_blank"  rel="noopener noreferrer">
...
function SkillsCard({id,name,items}){
    return (
        <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl- 4">
            <div className="card p-3 shadow p-3  bg-body rounded" key={id}>
 ...
 function CertificationsCard({id,title,institution,hours,issued,link}){
    ...
    return (
        <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl- 4">
            <div className="card p-3  shadow p-3  bg-body rounded" key={id} style={cardStyle}>
